...
///   - `draggable`: Makes the object draggable using touch and drag on the canvas. The default value is false.
...
public class Text: AbstractDrawable {
    ...
    /// - Parameter color: The color to draw the text. The default value is the system label color.
    /// - localizationKey: Text(string:fontSize:fontName:color:)
    public init(string: String, fontSize: Double = 17.0, fontName: String = "", color: Color = .systemLabel) {
