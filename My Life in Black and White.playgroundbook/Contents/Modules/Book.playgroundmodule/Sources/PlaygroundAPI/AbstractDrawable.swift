...
public class AbstractDrawable: Equatable {
    ...
    /// Makes the object draggable using touch and drag on the canvas. The default value is false.
    ...
    /// - parameter handler: The function to be called whenever a touch down occurs.
    ...
    /// - parameter handler: The function to be called whenever a touch up occurs.
    ...
    /// - parameter handler: The function to be called whenever a drag occurs.
    ...
    /// - parameter handler: The function to be called whenever a touch has been canceled.
